                        ...
                        <ul class="nav navbar-nav float-right">
                            ...
                            <li class="dropdown dropdown-user nav-item"><a
                                    ...
                                    <div class="user-nav d-sm-flex d-none"><span class="user-name">Admin</span><span
                                            class="user-status text-muted">{{ auth()->user()->name }}</span></div>
                                ...
                                <div class="dropdown-menu dropdown-menu-right p-0">
                                    <a class="dropdown-item" href="#" data-toggle="modal"
                                        data-target="#password_change_modal"><i class='bx bxs-lock-alt mr-50'></i>
                                        Change Password</a>
                ...
                <ul class="nav navbar-nav flex-row">
                    <li class="nav-item mr-auto"><a class="navbar-brand" href="{{ url('home') }}">
                            <div class="brand-logo">
                                <svg class="logo" width="26px" height="26px" viewbox="0 0 26 26"
                                    version="1.1" xmlns="http://www.w3.org/2000/svg"
                                    xmlns:xlink="http://www.w3.org/1999/xlink">
                                    <title>icon</title>
                                    <defs>
                                        <lineargradient id="linearGradient-1" x1="50%" y1="0%"
                                            x2="50%" y2="100%">
                                            <stop stop-color="#5A8DEE" offset="0%"></stop>
                                            <stop stop-color="#699AF9" offset="100%"></stop>
                                        </lineargradient>
                                        <lineargradient id="linearGradient-2" x1="0%" y1="0%"
                                            x2="100%" y2="100%">
                            ...
                            <h2 class="brand-text mb-0" style="margin-top: 0px;">Admin</h2>
                        </a></li>
                    <li class="nav-item nav-toggle"><a class="nav-link modern-nav-toggle pr-0"
                            data-toggle="collapse"><i class="bx bx-x d-block d-xl-none font-medium-4 primary"></i><i
                ...
                <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation"
                    ...
                    <li class="nav-item <?php if (request()->path() == 'admin/home') {
                        ...
                        <a href="{{ url('/admin/home') }}">
                            <i class="ficon bx bxs-dashboard" data-icon="envelope-pull"></i>
                            <span class="menu-title text-truncate" data-i18n="Email">Dashboard</span>
                        </a>
                    </li>

                    <li class="nav-item <?php if (request()->path() == 'admin/add-job-post') {
                        echo 'active';
                    } ?>">
                        <a href="{{ route('admin.postjob') }}">
                            <i class='bx bx-receipt' data-icon="check-alt"></i>
                            <span class="menu-title text-truncate" data-i18n="Todo">Post Job</span>
                        </a>
                    </li>

                    <li class="nav-item <?php if (request()->path() == 'admin/applied-candidates') { echo 'active';} ?>">
                        <a href="{{route('admin.applied_candidates')}}"> 
                        <i class="ficon bx bxs-file" data-icon="check-alt"></i>
                             <span class="menu-title text-truncate" data-i18n="Todo">Applied Candidate</span>
                        </a>
                    </li>

                    <li class="nav-item <?php if (request()->path() == 'admin/contact-us') {
                        echo 'active';
                    } ?>">
                        <a href="{{ route('admin.contact_us') }}">
                            <i class="ficon bx bxs-group" data-icon="check-alt"></i>
                            <span class="menu-title text-truncate" data-i18n="Todo">Contact Us</span>
                        </a>
                    </li>


                    {{-- <li class="nav-item <?php if (request()->path() == 'admin/corporate_event') {
                        echo 'active';
                    } ?>">
                        <a href="{{ url('/admin/corporate_event') }}">
                            <i class="ficon bx bxs-image-add" data-icon="check-alt"></i>
                            <span class="menu-title text-truncate" data-i18n="Todo">Corporate Event</span>
                        </a>
                    </li>
                    <li class="nav-item <?php if (request()->path() == 'admin/fun_event') {
                        echo 'active';
                    } ?>">
                        <a href="{{ url('/admin/fun_event') }}">
                            <i class="ficon bx bxs-image-add" data-icon="check-alt"></i>
                            <span class="menu-title text-truncate" data-i18n="Todo">Fun Event</span>
                        </a>
                    </li>
                    <li class="nav-item <?php if (request()->path() == 'admin/award_event') {
                        echo 'active';
                    } ?>">
                        <a href="{{ url('/admin/award_event') }}">
                            <i class="ficon bx bxs-image-add" data-icon="check-alt"></i>
                            <span class="menu-title text-truncate" data-i18n="Todo">Award & Recognition</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item <?php if (request()->path() == 'admin/notifications') {
                        ...
                        <a href="{{ url('/admin/notifications') }}">
                            <i class="ficon bx bxs-bell" data-icon="check-alt"></i>
                            <span class="menu-title text-truncate" data-i18n="Todo">Notification</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item <?php if (request()->path() == 'admin/settings') {
                        ...
                        <a href="{{ url('/admin/settings') }}">
                            <i class="ficon bx bxs-wrench" data-icon="check-alt"></i>
                            <span class="menu-title text-truncate" data-i18n="Todo">Settings</span>
                        </a>
                    </li> --}}
                </ul>
            </div>
