        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="ContactUsTable" class="table " style="width: 100%;">
                        <thead>
                            <tr>
                                <th>Company</th>
                                <th>Name</th>
...
$(document).ready( function () {
    ...
    var ContactUsTable = $('#ContactUsTable');
    // ContactUsTable.DataTable();  //uncomment below code & remove this line.
load_data();
function load_data()
{
    ContactUsTable.DataTable({
        ...
        processing: true,
        ordering: false,
        ajax: "{{route('admin.contact_us.data')}}",
        "aoColumns": [
            {
                mData: 'company'
            },
    ...
    const status_change = (id = 0, action = 'enable') => {
      $.ajax({
              ...
              success: function(result) {
                  ...
                  ContactUsTable.DataTable().ajax.reload();
              }
          });
    }
